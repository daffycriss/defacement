...
=====================
Controller Layer => Service Layer => Detection Engine => Repository Layer (JPA / Hibernate) => Database
...
- LogViewerService – Centralized activity logging
...
- Already customized to forward logs to Qradar SIEM
